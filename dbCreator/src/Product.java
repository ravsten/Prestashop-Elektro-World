public class Product {
    ...
    public void setProduct_id_string(String product_id_string) {
    ...
    public String getbSel() {
        return bSel;
    }

    public void setbSel(String bSel) {
        this.bSel = bSel;
    }
    ...
    public String getProductsGroupId() {
        return productsGroupId;
    }

    public void setProductsGroupId(String productsGroupId) {
    ...
    public String getNrOpinions() {
        return nrOpinions;
    }

    public void setNrOpinions(String nrOpinions) {
        this.nrOpinions = nrOpinions;
    }
    ...
    public void setCatL(String catL) {
        this.catL = catL;
    }
    ...
    public void setEnergyCard(String energyCard) {
